 ...
 * @brief Реализация выбора, оценки и сортировки кандидатных ходов.
 *
 * Файл обходит окрестности существующих камней, исключает занятые клетки и
 * дубликаты, определяет тактический ранг хода и считает итоговый ordering score
 * из атаки, защиты, тактической оценки и близости к центру.
 * 
 * Для пустой доски он возвращает ближайший к центру ход
 */
